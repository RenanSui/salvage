...
export default function Page() {
  ...
  return (
    <div className="flex justify-center items-center h-[calc(100vh-28px)] p-4 bg-accent dark:bg-transparent">
      <Card className="dark:bg-accent/20 w-full max-w-screen-sm">
        <CardHeader>
